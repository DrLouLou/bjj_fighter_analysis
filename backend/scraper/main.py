...
def main():
    ...
    try:
        ...
        for file in files:
            ...
            print(f'>>> Create {schema}.{file[7:-4]}.')
    ...
    try:
        ...
        print(f'>>> Create trusted.main_list.')

        con.sql(create_trusted_fighters_list)
        print(f'>>> Create trusted.fighters_list.')
    ...
    try:
        ...
        print(f'>>> Create refined.fight_record.')
    ...
    print(">>> Created adcc_historical_data.csv")
