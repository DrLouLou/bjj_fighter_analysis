...
const Adcc77kgSubFreqChart = () => {
  useLayoutEffect(() => {
    ...
    subsSeries.data.setAll([
      { submission: 'RNC', subs: 2 },
      { submission: 'Inside HH', subs: 3 },
      { submission: 'Outside HH', subs: 4 },
      { submission: 'Armbar', subs: 3 },
      { submission: 'Ankle Lock', subs: 10 },
      { submission: 'Guillotine', subs: 9 },
      // { submission: 'Triangle', subs: 0 },
      // { submission: 'Kneebar', subs: 0 },
      { submission: 'Arm Triangle', subs: 2 },
      { submission: 'Toe Hold', subs: 2 },
      // { submission: 'Kimura', subs: 0 },
      // { submission: 'Darce', subs: 0 },
      { submission: 'Choibar', subs: 2 },
      { submission: 'Smooother', subs: 0 },
      { submission: 'Ezekiel', subs: 1 },
      // { submission: 'Omoplata', subs: 0 },
      { submission: 'Anaconda', subs: 3 },
      { submission: 'Inv. Armbar', subs: 2 },
      { submission: 'Aoki Lock', subs: 3 },
      // { submission: 'Rear Triangle', subs: 0 },
      { submission: 'Americana', subs: 1 },
      ...
      { submission: 'Texas Brataplata', subs: 1 },
    ...
    failuresSeries.data.setAll([
      { submission: 'RNC', failures: 2 },
      { submission: 'Inside HH', failures: 1 },
      { submission: 'Outside HH', failures: 1 },
      { submission: 'Armbar', failures: 0 },
      { submission: 'Ankle Lock', failures: 0 },
      { submission: 'Guillotine', failures: 1 },
      // { submission: 'Triangle', failures: 0 },
      // { submission: 'Kneebar', failures: 0 },
      { submission: 'Arm Triangle', failures: 0 },
      { submission: 'Toe Hold', failures: 0 },
      // { submission: 'Kimura', failures: 0 },
      // { submission: 'Darce', failures: 0 },
      { submission: 'Choibar', failures: 0 },
      { submission: 'Smooother', failures: 1 },
      { submission: 'Ezekiel', failures: 0 },
      // { submission: 'Omoplata', failures: 0 },
      { submission: 'Anaconda', failures: 0 },
      { submission: 'Inv. Armbar', failures: 0 },
      ...
      // { submission: 'Linns Lock', failures: 0 },
      ...
      // { submission: 'E. Chairs/B.Split', failures: 0 },
...
export default Adcc77kgSubFreqChart;
