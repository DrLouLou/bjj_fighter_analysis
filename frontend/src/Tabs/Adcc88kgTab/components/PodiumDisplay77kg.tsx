...
const winnersData: Winner[] = [
    { name: "Giancarlo Bodoni", position: "1st" },
    { name: "Jacob Rodriguez", position: "2nd" },
    { name: "Felipe Costa", position: "3rd" }
];

const PodiumDisplay88kg: React.FC = () => {
  return (
    <div style={{ textAlign: 'center', padding: '20px' }}>
      <h2>-88kg Category Winners</h2>
...
export default PodiumDisplay88kg;
