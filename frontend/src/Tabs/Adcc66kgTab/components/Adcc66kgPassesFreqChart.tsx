...
const Adcc66kgPassesFreqChart = () => {
  useLayoutEffect(() => {
    ...
    const data: any[] = [
        ...
        { technique: "Knee slice", takedowns: 11, failures: 0 },
        { technique: "Toreando", takedowns: 8, failures: 0 },
        { technique: "Bodylock", takedowns: 6, failures: 0 },
        { technique: "NS Pass", takedowns: 6, failures: 0 },
        { technique: "3/4 Mount", takedowns: 0, failures: 1 },
        { technique: "Smash", takedowns: 2, failures: 1 },
        { technique: "Double under", takedowns: 0, failures: 7 },
...
export default Adcc66kgPassesFreqChart;
