...
const Adcc66kgSweepsFreqChart = () => {
  useLayoutEffect(() => {
    ...
    const data: any[] = [
        { technique: "Single leg", takedowns: 4, failures: 2 },
        { technique: "Sub sweep", takedowns: 0, failures: 2 },
        { technique: "Half guard", takedowns: 4, failures: 1 },
        { technique: "Kiss of the D", takedowns: 0, failures: 2 },
        { technique: "Lumberjack", takedowns: 1, failures: 0 },
        { technique: "Hook sweep", takedowns: 1, failures: 0 },
        { technique: "50/50", takedowns: 2, failures: 1 },
        { technique: "SLX", takedowns: 2, failures: 0 },
        { technique: "Matrix", takedowns: 1, failures: 1 },
        { technique: "Bodylock", takedowns: 3, failures: 1 },
        { technique: "X-guard", takedowns: 3, failures: 0 },
        { technique: "Scissor", takedowns: 0, failures: 1 },
        { technique: "Tornado", takedowns: 2, failures: 0 },
        { technique: "Berimbolo", takedowns: 1, failures: 0 },
        { technique: "Roll over", takedowns: 0, failures: 1 },
    ];
...
export default Adcc66kgSweepsFreqChart;
