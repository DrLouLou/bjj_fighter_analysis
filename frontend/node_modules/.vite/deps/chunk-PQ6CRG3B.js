...
async function createV3Controller(config) {
  ...
  const controller = await import("./StandardController-O6I24MWT.js");
...
async function createController(config) {
  ...
  if (teamsApp.isAvailable()) {
    const controller = await import("./NestedAppAuthController-A7635QNE.js");
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-AZB7JMC3.js");
    }
  } catch (e) {
  }
  return void 0;
...
@azure/msal-browser/dist/index.mjs:
  (*! @azure/msal-browser v3.14.0 2024-05-07 *)
*/
//# sourceMappingURL=chunk-PQ6CRG3B.js.map
